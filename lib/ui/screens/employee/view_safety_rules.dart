...
class EmployeeViewSafetyRules extends StatefulWidget {
  EmployeeViewSafetyRules({this.user, this.auth});
  ...
  @override
  State createState() => _ViewSafetyRulesState();
}

class _ViewSafetyRulesState extends State<EmployeeViewSafetyRules> {
  @override
              ...
              Padding(
                ...
                child: StreamBuilder(
                  stream: Firestore.instance
                      .collection(DBConstants.DB_SAFETY_RULES)
