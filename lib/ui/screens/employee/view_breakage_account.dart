...
class ViewMyBreakageAccount extends StatefulWidget {
  ViewMyBreakageAccount({this.user, this.auth});
  ...
  @override
  State createState() => _ViewMyBreakagesState();
}

class _ViewMyBreakagesState extends State<ViewMyBreakageAccount> {
  @override
  Widget build(BuildContext context) {
    ...
    if (!widget.appState.isLoading &&
      ...
      var shop = utf8.encode(employeeId); // data being hashed
      var account_id = sha1.convert(shop).toString();

      return Scaffold(
          drawer: EmployeeDrawer(),
          appBar: new AppBar(
            title: new Text('My Breakages Account'),
            centerTitle: true,
          ),
    ...
    ListView getNoteListView() {
      return ListView.builder(
        ...
        itemBuilder: (BuildContext context, int positon) {
          String amount = document[positon].data['account'].toString();
                  ...
                  trailing: GestureDetector(
                    ...
                    onTap: () {
                      ...
                      Scaffold.of(context).showSnackBar(new SnackBar(
                          content: new Text('Safety Rule Deleted')));
                    },
                  ),
                  onTap: () {
