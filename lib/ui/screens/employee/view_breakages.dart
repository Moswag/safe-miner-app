...
import 'add_breakage.dart';
import 'employee_drawer.dart';

class ViewMyBreakages extends StatefulWidget {
  ViewMyBreakages({this.user, this.auth});
...
class _ViewMyBreakagesState extends State<ViewMyBreakages> {
  @override
          ...
          floatingActionButton: FloatingActionButton(
            onPressed: () {
              ...
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (BuildContext context) => AddBreakage(
                            companyId: companyId,
    ...
    ListView getNoteListView() {
      return ListView.builder(
        ...
        itemBuilder: (BuildContext context, int positon) {
          String tool = document[positon].data['tool'].toString();
          String event = document[positon].data['event'].toString();
