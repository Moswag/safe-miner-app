...
class EmployeeViewCompanyRules extends StatefulWidget {
  EmployeeViewCompanyRules({this.user, this.auth});
...
class _ViewCompanyRulesState extends State<EmployeeViewCompanyRules> {
  @override
