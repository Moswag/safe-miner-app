...
import 'add_company_rule.dart';
import 'admin_drawer.dart';

class ViewCompanyRules extends StatefulWidget {
  ViewCompanyRules({this.user, this.auth});
  ...
  @override
  State createState() => _ViewCompanyRulesState();
}

class _ViewCompanyRulesState extends State<ViewCompanyRules> {
  @override
          ...
          floatingActionButton: FloatingActionButton(
            onPressed: () {
              ...
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (BuildContext context) => AddCompanyRule(
                            companyId: companyId,
                          )));
            },
              ...
              Padding(
                ...
                child: StreamBuilder(
                  stream: Firestore.instance
                      .collection(DBConstants.DB_COMPANY_RULES)
    ...
    ListView getNoteListView() {
      return ListView.builder(
        ...
        itemBuilder: (BuildContext context, int positon) {
          ...
          String rule = document[positon].data['rule'].toString();
