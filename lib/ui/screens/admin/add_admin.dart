...
class AddAdminForCompany extends StatefulWidget {
  AddAdminForCompany({this.companyId});
  String companyId;
  @override
  State createState() => _AddAdminForCompanyState();
}

class _AddAdminForCompanyState extends State<AddAdminForCompany> {
    ...
    if (_formKey.currentState.validate()) {
      try {
        ...
        AlertDiag.showAlertDialog(
            ...
            RouteConstants.ADMIN_VIEW_ADMINS);
      } catch (e) {
