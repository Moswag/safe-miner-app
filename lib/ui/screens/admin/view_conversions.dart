...
class ViewCompanyConversions extends StatefulWidget {
  ViewCompanyConversions({this.user});
...
class _ViewCompanyConversionsState extends State<ViewCompanyConversions> {
  @override
