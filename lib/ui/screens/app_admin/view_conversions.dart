...
import 'add_conversion.dart';
import 'app_admin_drawer.dart';

class ViewConversions extends StatefulWidget {
  ViewConversions({this.user});

  final FirebaseUser user;

  @override
  State createState() => _ViewConversionsState();
}

class _ViewConversionsState extends State<ViewConversions> {
  @override
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: () {
            ...
            Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (BuildContext context) => AddConversion()));
          },
