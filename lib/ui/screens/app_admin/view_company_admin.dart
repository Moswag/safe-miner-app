...
import 'add_company_admin.dart';
import 'app_admin_drawer.dart';

class ViewCompanyAdmins extends StatefulWidget {
  ViewCompanyAdmins({this.user});

  final FirebaseUser user;

  @override
  State createState() => _ViewCompanyAdminsState();
}

class _ViewCompanyAdminsState extends State<ViewCompanyAdmins> {
  @override
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: () {
            ...
            Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (BuildContext context) => AddCompanyAdmin()));
          },
